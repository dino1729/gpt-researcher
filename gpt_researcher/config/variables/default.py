...
DEFAULT_CONFIG: BaseConfig = {
    ...
    "FAST_LLM": "",  # Must be set in .env file (e.g., FAST_LLM=openai:gpt-4o-mini)
    "SMART_LLM": "",  # Must be set in .env file (e.g., SMART_LLM=openai:gpt-4o)
    "STRATEGIC_LLM": "",  # Must be set in .env file (e.g., STRATEGIC_LLM=openai:o1-mini)
