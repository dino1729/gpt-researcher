  ...
  const initializeWebSocket = useCallback((
    ...
    if (typeof window !== 'undefined') {
      ...
      newSocket.onopen = () => {
        ...
        const { report_type, report_source, tone, mcp_enabled, mcp_configs, mcp_strategy, llm_provider_mode } = chatBoxSettings;
        ...
        try {
          ...
          const dataToSend = { 
            ...
            llm_provider_mode: llm_provider_mode || 'litellm'
          };
