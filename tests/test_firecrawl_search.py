...
# Set defaults only if not provided externally
if not os.environ.get("FIRECRAWL_SERVER_URL"):
    os.environ["FIRECRAWL_SERVER_URL"] = "http://localhost:3002"

# Empty for passwordless server; leave any externally provided key intact
